...
ybar=(normpdf(xTe(1,:),0,1).*normpdf(xTe(2,:),0,1)+2.*normpdf(xTe(1,:),OFFSET,1).*normpdf(xTe(2,:),OFFSET,1))./(normpdf(xTe(1,:),0,1).*normpdf(xTe(2,:),0,1)+normpdf(xTe(1,:),OFFSET,1).*normpdf(xTe(2,:),OFFSET,1));
